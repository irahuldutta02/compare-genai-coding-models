    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section id="pricing" className="bg-gray-800 py-20">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-4xl font-bold mb-8">Pricing Plans</h3>
          <div className="grid md:grid-cols-3 gap-8">
            {["Basic", "Pro", "Enterprise"].map((plan) => (
              ...
              >
                ...
                <button className="bg-indigo-600 px-6 py-2 rounded-md font-semibold hover:bg-indigo-500 transition duration-300">
                  Choose Plan
                </button>
              </div>
            ))}
